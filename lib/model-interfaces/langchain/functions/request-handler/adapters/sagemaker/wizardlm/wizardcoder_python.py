...
class WizardCoderContentHandler(LLMContentHandler):
...
content_handler = WizardCoderContentHandler()

class SMWizardCoderAdapter(ModelAdapter):
...
registry.register(r"(?i)sagemaker\.wizardlm-WizardCoder*", SMWizardCoderAdapter)
